...
st.title("Temperature over the years")
print(os.getcwd())
...
with st.container():
    ...
    with col5:
        st.metric("Number of years in range: ", value=top_year - lower_year)
    ...
    with col1:
        ...
        st.metric("Temperature difference ", value=f"{lower_year} -> {top_year}", delta=f"{round(top_year_temperature-lower_year_temperature,2)} °C")
